...
## Algorithm
```
1.Load and Prepare the Dataset:Import the employee dataset, handle missing values if any, and separate the features (inputs) and target variable (employee churn).
2.Split and Train the Model:Divide the dataset into training and testing sets, then create and train the Decision Tree Classifier using the training data.
3.Predict Employee Churn:Use the trained model to predict employee churn for the testing dataset.
4.Evaluate the Model Performance:Calculate accuracy, confusion matrix, and classification report to measure the performance of the Decision Tree model.
```
## Program:
```
/*
...
csv_path = r"C:\Users\acer\Downloads\Employee.csv"   # <-- change if file is somewhere else
try:
...
<img width="852" height="881" alt="image" src="https://github.com/user-attachments/assets/8eee42f5-bf4a-4672-9f2e-9dedccade650" />
<img width="782" height="932" alt="image" src="https://github.com/user-attachments/assets/c2e4bee8-c645-4027-93e4-0743ba7a7d2d" />
